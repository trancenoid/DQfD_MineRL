...
class MineRL_DQfDConfig(Config):
    demo_mode = 'use_demo'
    demo_num = int(Config.BATCH_SIZE * Config.DEMO_RATIO)
    ENV_NAME = "MineRLTreechop-v0"
    MODEL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'model/minerl_DQfD_model')
    DEMO_DATA_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'minerl_demo.p')
    iteration = 1
    demo_buffer_size = 400000
    replay_buffer_size = demo_buffer_size * 2
